...
//	custom code
//	self.languages = [[NSMutableArray alloc] initWithObjects:@"English", @"Deutsch", @"Český", @"Dansk", @"Español", @"Français", @"Italiano", @"日本の", @"Polski", @"Português", @"pусский", nil];
	self.languages = [[NSMutableArray alloc] initWithObjects:@"English", @"Deutsch", @"Français", @"Italiano", @"日本の", @"Polski", @"Português", @"pусский", nil];
	// get the prefs
...
-(void)reloadPages:(NSString *)language {	
	...
	if([language isEqualToString:@"English"]) {
		...
		self.languageDirectory = @"fr.lproj";
	} else if([language isEqualToString:@"Italiano"]) {
		self.languageDirectory = @"it.lproj";
	}
...
-(void)createPages:(NSString *)language {
	...
	if([language isEqualToString:@"English"]) {
		...
		[data setValue:@"Introduction" forKey:@"00"];
		[data setValue:@"L’esprit du Jeu" forKey:@"01"];
		[data setValue:@"Aire de Jeu" forKey:@"02"];
		[data setValue:@"Équipement" forKey:@"03"];
		[data setValue:@"Point, But et Jeu" forKey:@"04"];
		[data setValue:@"Équipes" forKey:@"05"];
		[data setValue:@"Commencer un Match" forKey:@"06"];
		[data setValue:@"Le “Pull” (Engagement)" forKey:@"07"];
		[data setValue:@"Statut du Disque" forKey:@"08"];
		[data setValue:@"“Stall Count” (Le Compte)" forKey:@"09"];
		[data setValue:@"Le “Check”" forKey:@"10"];
		[data setValue:@"“Out” (Hors-Jeu)" forKey:@"11"];
		[data setValue:@"Réceptionneur et Positionnement" forKey:@"12"];
		[data setValue:@"“Turnovers”" forKey:@"13"];
		[data setValue:@"Marquer un point" forKey:@"14"];
		[data setValue:@"Appeler les Fautes, Infractions et Violations" forKey:@"15"];
		[data setValue:@"Continuité après un appel de Faute ou Violation" forKey:@"16"];
		[data setValue:@"Fautes" forKey:@"17"];
		[data setValue:@"Infractions et Violations" forKey:@"18"];
		[data setValue:@"Interruptions" forKey:@"19"];
		[data setValue:@"Temps-Morts (“Time-Outs”)" forKey:@"20"];
		[data setValue:@"Dèfinitions" forKey:@"21"];
		[data setValue:@"License Légale" forKey:@"22"];
	} else if([language isEqualToString:@"Italiano"]) {
		[data setValue:@"Introduzione" forKey:@"00"];
		[data setValue:@"Spirit of the Game (Spirito del Gioco)" forKey:@"01"];
		[data setValue:@"Campo di gioco" forKey:@"02"];
		[data setValue:@"Equipaggiamento" forKey:@"03"];
		[data setValue:@"Punto, meta e partita" forKey:@"04"];
		[data setValue:@"Squadre" forKey:@"05"];
		[data setValue:@"Iniziare la partita" forKey:@"06"];
		[data setValue:@"Lancio iniziale" forKey:@"07"];
		[data setValue:@"Stato del disco" forKey:@"08"];
		[data setValue:@"Conteggio" forKey:@"09"];
		[data setValue:@"Check (controllo)" forKey:@"10"];
		[data setValue:@"Fuori campo" forKey:@"11"];
		[data setValue:@"Ricevitori e disposizione" forKey:@"12"];
		[data setValue:@"Turnover (cambi di possesso)" forKey:@"13"];
		[data setValue:@"Segnare una meta" forKey:@"14"];
		[data setValue:@"Chiamare i falli, le infrazioni e le violazioni" forKey:@"15"];
		[data setValue:@"Proseguire dopo una chiamata di fallo o di violazione" forKey:@"16"];
		[data setValue:@"Falli" forKey:@"17"];
		[data setValue:@"Infrazioni e violazioni" forKey:@"18"];
		[data setValue:@"Interruzioni" forKey:@"19"];
		[data setValue:@"Time-Out (pause)" forKey:@"20"];
		[data setValue:@"Glossario" forKey:@"21"];
		[data setValue:@"Licenza Legale" forKey:@"22"];
	}
